...
>
  <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-0">
    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-start gap-3 w-full sm:w-[400px]">
      ...
      <button className="bg-[#0E324D] text-white px-6 py-2 hover:bg-blue-700 transition duration-200 w-full sm:w-auto">
        Subscribe
      </button>
    </div>
  </div>
