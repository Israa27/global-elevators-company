...
export default function HeroSection() {
  ...
  return (
    <section className="w-full  bg-[#F2F2F2]  mt-6 px-5 py-3 rounded overflow-hidden flex justify-between  ">
        
    <div className="hero text-left p-8 w-96">
    ...
    <div className="w-[50%]  p-4 ">
            <img src={img} className="w-fit h-fit" alt=''/>
        </div>
    </section>
  );
}
